...
$(document).ready(function () {
   ...
   //peso
        ...
        $.ajax({
            ...
            .done(function (res) {
                if (res.success) {
                    ...
                    const estadoClass = getEstadoBadgeClass(res.unidad.estado);
    ...
    function getEstadoBadgeClass(estado) {
        ...
        if (e === "Asignada") return "badge-warning";
    ...
    function renderizarTabla(unidades) {
        ...
        unidades.forEach(function (u) {
            ...
            const estadoClass = getEstadoBadgeClass(u.estadoUnidad);
            const estadoLabel = u.estadoUnidad || "Disponible";
